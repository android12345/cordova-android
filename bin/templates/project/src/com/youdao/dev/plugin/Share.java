...
public class Share extends CordovaPlugin {
	...
	public final String REGISTERUM = "registerUmeng";
	public final String REGISTERWX = "registerWeixin";
	...
	public boolean execute(String action, JSONArray args,
		...
		// return true ;
			...
			// CommUtils.showMessage("你还没有注册友盟，清先注册",
	...
	// */
	// private void registerUmeng(String uMengID, CallbackContext
	// callbackContext) {
	 ...
	 *            回调
	 */
	private void ShareInfo(final ShareInfo shareInfo,
		...
		try {
			...
			// 获得PackageManager对象
			// PackageInfo info =
			// pm.getPackageInfo(this.cordova.getActivity().getPackageName(),
			// 0);
			...
			// ComponentName ac =
			// it.resolveActivity(pm);//mPackageManager为PackageManager实例
			// //得到主Activity的名字
			// String mainActivityName =ac.getClassName() ;
			// // Toast.makeText(this.cordova.getActivity(), classname+"",
			// 1).show() ;
			//
			// //用反射调用
			...
			Runnable runnable = new Runnable() {
				...
				public void run() {
					...
					shareUtil.share(cordova.getActivity(),
							shareInfo);
					shareUtil = null;
